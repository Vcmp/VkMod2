...
inline void Texture::createDepthResources() {
  ...
  Texture::createImage(SwapChainSupportDetails::swapChainExtent, depthFormat,
                       VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT);

  createImageView(depthFormat, VK_IMAGE_ASPECT_DEPTH_BIT, depthImageView);
  transitionImageLayout(depthFormat, VK_IMAGE_LAYOUT_UNDEFINED,
...
inline void Texture::createImage(VkExtent2D extent, VkFormat format,
  ...
  allocInfo.memoryTypeIndex = BuffersX::findMemoryType(
      Queues::physicalDevice, memRequirements.memoryRequirements.memoryTypeBits,
...
static void Texture::transitionImageLayout(VkFormat format,
  ...
  VkImageMemoryBarrier barrier = {
      ...
      barrier.subresourceRange = {.aspectMask =
                                      static_cast<VkImageAspectFlags>((format)),
                                  .baseMipLevel = (0),
                                  .levelCount = (1),
                                  .baseArrayLayer = (0),
                                  .layerCount = (1)},
